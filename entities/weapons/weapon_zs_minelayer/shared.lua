SWEP.PrintName = "'캐리언' 충격 지뢰 발사기"
SWEP.Description = "바닥에 부착되는 간단한 지뢰를 설치하는 무기."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'스파클러' 레이저 지뢰 발사기", "몇 초 동안 피해가 지속되는 레이저 지뢰를 발사한다.", function(wept)
