SWEP.PrintName = "'캐런' 연발 크로스보우"
SWEP.Description = "다른 것 도움 없이도 아주 빠르게 쏠 수 있다. 그런데 명중률이 안 좋다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'스틱스' 연발 크로스보우", "장탄수가 늘어나고 연사력이 향상되지만, 정확도와 데미지, 재장전 속도가 감소한다.", function(wept)
