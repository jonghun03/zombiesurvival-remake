SWEP.PrintName = "'노바 블래스터' 펄스 리볼버"
SWEP.Description = "콤바인이 매그넘을 개조하여 펄스를 쏘게 만들었다. 좀비를 느리게 한다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'노바 헬릭스' 펄스 리볼버", "물결 모양으로 두 개의 발사체를 발사한다.", function(wept)
