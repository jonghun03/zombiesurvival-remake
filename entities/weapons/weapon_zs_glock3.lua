...
SWEP.Description = "3발을 한번에 쏜다. 그리 명중률이 좋진 않지만 가까이서 쏘면 좋다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'콜라이더' 글록0 3", "1발을 적게 쏘지만 정확도가 증가하며, 기본 데미지가 증가하고, 리퍼 스택을 활용할 수 있는 기회가 있다.", function(wept)
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 2, "'슈라우드' SOCOM 마크 23", "단발 사격을 한다. 좀비에게 잘 들키지 않도록 오오라를 숨겨주며, 정확도가 증가한다. 하지만 공격력이 감소한다.", function(wept)
