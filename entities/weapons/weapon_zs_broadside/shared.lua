SWEP.PrintName = "'브로드사이드' 미사일 런처"
SWEP.Description = "상당한 범위에 폭발적인 피해를 처리하는 미사일을 발사한다. 우클릭으로 미사일 조종이 가능하다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'일제 사격' 마이크로 미사일 런처", "총알의 33%만 소비하는 빠르고 작은 미사일을 난사한다.", function(wept)
