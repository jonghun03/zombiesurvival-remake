...
SWEP.PrintName = "'크리티컬' 리볼버"
SWEP.Description = "파편으로 퍼진 권총탄 2발을 소비하는 무거운 권총."
SWEP.Slot = 1
SWEP.SlotPos = 0
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'건슬링어' 권총", "빠르게 발사하고, 탄창수가 증가했지만 데미지가 감소한다.", function(wept)
