SWEP.PrintName = "'헬리오스' 글루온 건"
SWEP.Description = "대상에게 뜨거운 것을 계속 발사하며 지속적으로 막대한 피해를 입힌다. 계속 쏘면 과열되어 냉각시켜야 한다."
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'하데스' 힉스 건", "피해가 줄어드는 대신 펄스의 느림 디버프가 생긴다.", function(wept)
...
branch.NewNames = {"깊숙한", "무효한", "공허한"}

GAMEMODE:AddNewRemantleBranch(SWEP, 2, "'타르타로스' 뮤온 건", "열로 더 많은 피해를 입히지만 사거리가 감소하고 과열할 경우 자기 자신이 피해를 입을 수 있다.", function(wept)
