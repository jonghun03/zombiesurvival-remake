...
SWEP.PrintName = "'잭해머' 자동 샷건"
SWEP.Description = "많은 탄창수를 가진 자동 드럼 샷건이다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'앤빌' 자동샷건", "3발을 한번에 발사하여 데미지가 약간 증가하지만, 정확도가 떨어진다.", function(wept)
