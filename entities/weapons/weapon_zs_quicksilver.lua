...
SWEP.PrintName = "'퀵실버' 반자동 소총"
SWEP.Description =  "연사력이 높고 장탄수가 많으며 적당히 강하다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'머큐리얼' 밀렵 소총", "더 많은 피해를 입히지만 정확도가 떨어진다.", function(wept)
