...
SWEP.Description = "이 총을 사용하면 좀비가 자신의 오오라를 볼 수있는 거리가 크게 줄어 듭니다.."
SWEP.Slot = 2
SWEP.SlotPos = 0
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'아스피런트' M4", "데미지가 증가하고, 느리게 쏘지만, 3점사를 할 때 정확도가 증가한다.", function(wept)
