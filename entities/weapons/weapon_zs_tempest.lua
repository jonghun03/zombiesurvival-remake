...
SWEP.PrintName = "'템페스트' 연사 권총"
SWEP.Description = "빠르게 발사하며 탄약을 매우 빨리 사용한다."
SWEP.Slot = 1
SWEP.SlotPos = 0
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'템페스트' 자동 권총", "데미지를 희생하여 자동 권총으로 만든다.", function(wept)
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 2, "'코스모스' 펄스 블래스터", "펄스를 난사하는 권총으로 개조한다.", function(wept)
