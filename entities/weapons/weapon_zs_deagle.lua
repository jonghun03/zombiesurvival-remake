...
SWEP.Description = "이 권총은 다른 권총보다 더 많은 넉백을 가진 고성능 탄환을 사용한다." --SWEP.Description = "This high-powered handgun has the ability to pierce through multiple zombies. The bullet's power decreases by half which each zombie it hits."
SWEP.Slot = 1
SWEP.SlotPos = 0
