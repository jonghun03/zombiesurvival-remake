...
SWEP.PrintName = "'허리케인' 펄스 SMG"
SWEP.Description = "타겟을 느리게 하는 펄스를 빠르게 발사한다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'태풍' 펄스 SMG", "데미지가 적어지지만, 정확도가 증가하고, 추가 데미지를 얻는다.", function(wept)
