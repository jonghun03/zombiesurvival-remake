...
SWEP.PrintName = "'스플린터' 소드오프 샷건"
SWEP.Description = "한 번에 두발을 발사하여 많은 피해를 입힐 수 있습니다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'스플린터' 슬러그 샷건", "단발의 정확한 사격을 하지만, 총 데미지는 낮아진다.", function(wept)
