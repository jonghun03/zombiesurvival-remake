...
SWEP.PrintName = "'퀘이사' 펄스 소총"
SWEP.Description = "스코프가 달린 대상을 느리게 하는 펄스를 쏘는 소총이다. 한발에 펄스 에너지를 4만큼 소비한다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'블레이저' 3단 펄스 라이플", "한 방향으로만 퍼지는 3개의 펄스 샷을 발사하고 전체 피해량이 증가한다.", function(wept)
