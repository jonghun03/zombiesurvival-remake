SWEP.PrintName = "'헤파이스토스' 타우 캐논"
SWEP.Description = "가우스 건이라고도 알려져 있다. 믿지 못할 정도의 빠른 속도로 타우 광선을 발사한다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'프로메테우스' 타우 캐논", "낮은 각도에서 3번 튀고, 더 빨리 충전하고, 발사 딜레이가 증가한다.", function(wept)
