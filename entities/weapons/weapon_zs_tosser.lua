...
SWEP.PrintName = "'토져' SMG"
SWEP.Description = "적당한 연사율과 재장전 속도를 가진 비교적 간단한 SMG."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'쓰로어' SMG", "데미지가 증가했지만, 3점사밖에 되지 않는다.", function(wept)
