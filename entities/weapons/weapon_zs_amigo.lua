...
SWEP.PrintName = "'아미고' 돌격소총"
SWEP.Description = "추가 헤드샷 피해를 입히긴 하지만 연사력이 느립니다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "'동료' 마이크로노트 소총", "정확도와 데미지가 감소헀지만 데미지가 증가하고 추가 투사체를 발사한다.", function(wept)
...
local branch = GAMEMODE:AddNewRemantleBranch(SWEP, 2, "'호라이즌' 돌격 소총", "연사력이 느리지만 명중률, 데미지가 강해진다.", function(wept)
