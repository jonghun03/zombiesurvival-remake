...
SWEP.PrintName = "갈고리"
SWEP.Description = "좀비를 찌르며, 몇 초동안 지속하여 피해를 입힌다. 다시 주워서 쓸 수 있다."
...
GAMEMODE:AddNewRemantleBranch(SWEP, 1, "고기 갈고리", "더 적은 데미지를 주지만 그로 인해 영향을 받는 좀비는 어떻게든 더 많은 데미지를 입는다.", function(wept)
	wept.Weaken = true
