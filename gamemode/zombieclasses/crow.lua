...
CLASS.Hull = {Vector(-16, -16, 0), Vector(16, 16, 12)}
CLASS.HullDuck = {Vector(-16, -16, 0), Vector(16, 16, 12)}
CLASS.ViewOffset = Vector(0,0,34)
CLASS.ViewOffsetDucked = Vector(0,0,34)
CLASS.CrouchedWalkSpeed = 1
CLASS.StepSize = 16
CLASS.Mass = 2
CLASS.ModelScale = 5.5	--크기
