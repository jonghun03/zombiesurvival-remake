CLASS.Name = "살인귀"
CLASS.TranslationName = "class_butcher2"
CLASS.Description = "description_butcher2"
CLASS.Help = "controls_butcher2"
...
CLASS.SWEP = "weapon_zs_butcherknifez2"
