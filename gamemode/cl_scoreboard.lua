...
function PANEL:Init()
	...
	self.m_PointsLabel = EasyLabel(self, "점수", "ZSScoreBoardPlayer", COLOR_GRAY)
	self.m_RemortCLabel = EasyLabel(self, "환생", "ZSScoreBoardPlayer", COLOR_GRAY)

	self.m_BrainsLabel = EasyLabel(self, "뇌", "ZSScoreBoardPlayer", COLOR_GRAY)
	self.m_RemortCZLabel = EasyLabel(self, "환생", "ZSScoreBoardPlayer", COLOR_GRAY)
