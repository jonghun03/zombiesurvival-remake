...
function meta:CreateTrinketStatus(status)
	if self.m_PreRedeem and Config.NoRedeemerSkill then return end
...
function meta:ApplySkills(override)
	...
	if self.m_PreRedeem and Config.NoRedeemerSkill then return end --Config.lua에서 구원자 스킬 껐다 켰다 할 수 있음
