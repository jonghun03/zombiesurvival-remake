...
GM.WeaponStatBarVals = {
	{"MeleeDamage", "데미지", 2, 140, false},
	{"MeleeRange", "범위", 30, 100, false},
	{"MeleeSize", "크기", 0.2, 3, false},

	{"Damage", "데미지", 1, 105, false, "Primary"},
	{"Delay", "공격 딜레이", 0.05, 2, true, "Primary"},
	{"ClipSize", "탄창", 1, 35, false, "Primary"},

	{"ConeMin", "최소 탄퍼짐", 0, 5, true},
	{"ConeMax", "최대 탄퍼짐", 1.5, 7, true},
	{"WalkSpeed", "이동 속도", 200, 250, false}
}
