...
SPEED_NORMAL = 225
SPEED_SLOWEST2 = SPEED_NORMAL - 110
...
SPEED_FASTEST2 = SPEED_NORMAL + 180
...
GM.BarricadeHealthMin = 150						--최소 바리내구도
GM.BarricadeHealthMax = 80000 * 0.85			--최대 바리내구도
GM.BarricadeHealthMassFactor = 75 * 0.85		--질량 배수(바리의 체력을 결정함)
GM.BarricadeHealthVolumeFactor = 30 * 0.85		--간격
GM.BarricadeRepairCapacity = 1.25

GM.BossZombiePlayersRequired = 5				--플레이어 인원수에 따른 보스 생성
...
GM.AmmoNames = {}
GM.AmmoNames["ar2"] = "돌격소총탄"
GM.AmmoNames["pistol"] = "권총탄"
GM.AmmoNames["smg1"] = "SMG탄"
...
GM.AmmoNames["striderminigun"] = "메세지 비콘"
GM.AmmoNames["helicoptergun"] = "보급 상자"
GM.AmmoNames["slam"] = "방어막 전개 장치"
GM.AmmoNames["spotlamp"] = "스팟 램프"
GM.AmmoNames["stone"] = "돌맹이"
GM.AmmoNames["flashbomb"] = "섬광탄"
GM.AmmoNames["betty"] = "지뢰"
GM.AmmoNames["molotov"] = "화염병"
GM.AmmoNames["manhack"] = "맨핵"
GM.AmmoNames["manhack_saw"] = "톱날 맨핵"
GM.AmmoNames["drone"] = "드론"
GM.AmmoNames["sigilfragment"] = "장치 파편"
GM.AmmoNames["corruptedfragment"] = "오염된 장치 파편"
GM.AmmoNames["mediccloudbomb"] = "회복탄"
GM.AmmoNames["nanitecloudbomb"] = "나노 수리 폭탄"
GM.AmmoNames["foodwatermelon"] = "수박"
GM.AmmoNames["foodorange"] = "오렌지"
GM.AmmoNames["foodbanana"] = "바나나"
GM.AmmoNames["foodsoda"] = "소다 캔"
GM.AmmoNames["foodmilk"] = "우유팩"
GM.AmmoNames["foodtakeout"] = "포장 음식"
GM.AmmoNames["foodwater"] = "물병"
GM.AmmoNames["pulse"] = "펄스 에너지"
GM.AmmoNames["impactmine"] = "폭발물"
GM.AmmoNames["chemical"] = "화학 약품"
GM.AmmoNames["repairfield"] = "수리 장치"
GM.AmmoNames["zapper"] = "코일"
GM.AmmoNames["zapper_arc"] = "아크 코일"
GM.AmmoNames["remantler"] = "무기 정제기"
GM.AmmoNames["turret_buckshot"] = "샷건 터렛"
GM.AmmoNames["turret_assault"] = "어썰트 터렛"
GM.AmmoNames["scrap"] = "고철"
